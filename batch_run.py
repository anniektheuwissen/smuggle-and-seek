...
if __name__ == "__main__":
    ...
    for data in ["customs points", "caught packages"]:
        ...
        boxplot = axes[0].boxplot([results_2x2_0vs0[data], results_2x2_1vs0[data], results_2x2_2vs0[data]], widths = 0.6,
                                labels=['ToM0', 'ToM1', 'ToM2'], patch_artist=True, medianprops={'color': 'black'}
                                    )
        ...
        axes[0].set_title('ToM0 smuggler', fontsize=30)
        ...
        axes[1].set_title('ToM1 smuggler', fontsize=30)
        axes[1].set_xlabel('customs order of theory of mind')
        ...
        axes[2].set_title('ToM2 smuggler', fontsize=30)
